...
<main class="main" id="top">
  ...
  <div class="bg-holder overlay overlay-freya"> <img class="img-fluid" src="<?= $this->Path->getTemplatePath() ?>assets/img/img_3.jpg" alt="Residential" /> <data-parallax="data-parallax" data-rellax-speed="-3"></div>
   <!--/.bg-holder-->
   <div class="container">
